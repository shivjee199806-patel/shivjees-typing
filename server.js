...
app.post('/api/auth/owner-private-login',authRateLimit,(req,res)=>{try{
 ...
 if(!u.owner_security_code_hash)return res.status(428).json({error:'SECURITY_CODE_SETUP_REQUIRED',setup_required:true});
