...
app.get('/api/razorpay/config',auth,(req,res)=>res.json({payment_enabled:paymentSystemEnabled(),configured:paymentSystemEnabled()&&razorpayConfigured(),key_id:razorpayConfigured()?String(process.env.RAZORPAY_KEY_ID):null,name:"Shivjee's Typing"}));
